...
<body>
	...
	<div class="row">
		...
		<ul>
			...
			<li> <a href="receivesubmission.php" class="a2"> Submission </a> </li>
			<li> <a href="sendmessage.php" class="a2"> Message </a> </li>
			<li> <a href="salary.php" class="a2"> Salary </a> </li>
			<li> <a href="getfeedback.php" class="a2"> Feedback </a> </li>
		</ul>
		</div>	
		
		<div class ="img col-4">
		<img src="Administrator/admin2.png" style="width:100%;height:270px;">
		</div>
		
		<div class ="calender col-5">
		</div>
	</div>
